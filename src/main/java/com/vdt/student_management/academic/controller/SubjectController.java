...
public class SubjectController {
    ...
    ResponseEntity<ApiResponse<PageResponse<SubjectResponse>>> getAllSubjects(Pageable pageable) {
        var response = ApiResponse.<PageResponse<SubjectResponse>>builder()
                .code(200)
                .data(PageResponse.fromPage(subjectService.getAllSubjects(pageable)))
                .build();
    ...
    ResponseEntity<ApiResponse<SubjectResponse>> getSubject(@PathVariable Long id) {
        var response = ApiResponse.<SubjectResponse>builder()
                .code(200)
    ...
    ResponseEntity<ApiResponse<SubjectResponse>> addSubject(@RequestBody AddSubjectRequest request) {
        var response = ApiResponse.<SubjectResponse>builder()
                .code(201)
                .data(subjectService.upsertSubject(null, request))
                .build();
    ...
    ResponseEntity<ApiResponse<SubjectResponse>> updateSubject(
            @PathVariable Long id, @RequestBody AddSubjectRequest request) {
        var response = ApiResponse.<SubjectResponse>builder()
                .code(200)
                .data(subjectService.upsertSubject(id, request))
                .build();
